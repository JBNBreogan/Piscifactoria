...
public class Recompensas {
    ...
    */
    ...
    private static AlmacenCentral almacenCentral = AlmacenCentral.getInstance();
                        ...
                        for (Piscifactoria piscifactoria : piscifactorias) {
                            ...
                            case "algae":
                                if (almacenCentral != null) {
                                    int capacidadDisponible = almacenCentral.getCapacidadComidaVegetal() - almacenCentral.getComidaVegetal();
                                    if (comidaRecompensa > capacidadDisponible) {
                                        almacenCentral.addFood(capacidadDisponible, "Vegetal");
                                    } else {
                                        almacenCentral.addFood(comidaRecompensa, "Vegetal");
                                    }
                                } else {
                            ...
                            case "general":
                                if( almacenCentral != null){
                                    int capacidadDisponibleAnimal = almacenCentral.getCapacidadComidaAnimal() - almacenCentral.getComidaAnimal();
                                    int capacidadDisponibleVegetal = almacenCentral.getCapacidadComidaVegetal() - almacenCentral.getComidaVegetal();
                                    
                                    if (comidaRecompensa > capacidadDisponibleAnimal) {
                                        almacenCentral.addFood(capacidadDisponibleAnimal, "Animal");
                                    } else {
                                        almacenCentral.addFood(comidaRecompensa, "Animal");
                                    }
                                    if (comidaRecompensa > capacidadDisponibleVegetal) {
                                        almacenCentral.addFood(capacidadDisponibleVegetal, "Vegetal");
                                    } else {
                                        almacenCentral.addFood(comidaRecompensa, "Vegetal");
                                    }
                                } else{
                            ...
                            case "animal":
                                  if (almacenCentral != null) {
                                    int capacidadDisponible = almacenCentral.getCapacidadComidaAnimal() - almacenCentral.getComidaAnimal();
                                    if (comidaRecompensa > capacidadDisponible) {
                                        almacenCentral.addFood(capacidadDisponible, "Animal");
                                    } else {
                                        almacenCentral.addFood(comidaRecompensa, "Animal");
                                    }
                                } else{
