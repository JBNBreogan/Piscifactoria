...
public abstract class Pez {
    ...
    /**
     * Constructor de carga de datos
     * 
     * @param peskineitor el DTO del pez
     */
    protected Pez(DTOPez peskineitor, PecesDatos data) {
        this.Edad = peskineitor.getEdad();
        this.Sexo = peskineitor.isSexo();
        this.Vivo = peskineitor.isVivo();
        this.Fertil = peskineitor.isFertil();
        this.UltimaPuesta = peskineitor.getCiclo();
        this.Comido = peskineitor.isAlimentado();
    ...
    /**
     * Hace crecer el pez un día, teniendo en cuenta todos los factores, y
     * devolviendo la cantidad de comida que consume
     * 
    ...
    /**
     * Hace comer al pez si hay comida suficiente, y devuelve la cantidad que
     * consume.
     * 
